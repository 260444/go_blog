...
// esExportCmd represents the esExport command
var esExportCmd = &cobra.Command{
	Use:   "esExport",
	Short: "导出 ES 中的数据到 JSON 文件",
	Long:  `导出 ES 中的数据到 JSON 文件`,
	Run: func(cmd *cobra.Command, args []string) {
		err := ElasticsearchExport()
		if err != nil {
			panic(err)
		}
	},
...
func init() {
	rootCmd.AddCommand(esExportCmd)
}
